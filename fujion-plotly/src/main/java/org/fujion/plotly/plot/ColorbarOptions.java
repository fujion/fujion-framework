...
public class ColorbarOptions extends Options {
     ...
     * between ticks to one day, set "dtick" to 86400000.0. "date" also has special values "M<n>"
     * gives ticks spaced by a number of months. "n" must be a positive integer. To set ticks on the
     * 15th of every third month, set "tick0" to "2000-01-15" and "dtick" to "M3". To set ticks
     * every 4 years, set "dtick" to "M48"
     */
     ...
     * the "tick0" to 2) except when "dtick"="L<f>" (see "dtick" for more info). If the axis "type"
     * is "date", it should be a date string, like date data. If the axis "type" is "category", it
     * should be a number, using the scale where each category is assigned a serial number from zero
