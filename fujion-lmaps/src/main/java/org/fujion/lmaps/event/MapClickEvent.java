...
public class MapClickEvent extends Event {
    ...
    protected void afterInitialized() {
        ...
        location = new LatLng(_location.get("lat"), _location.get("lng"));
        layerPoint = new Point(_layerPoint.get("x"), _layerPoint.get("y"));
        containerPoint = new Point(_containerPoint.get("x"), _containerPoint.get("y"));
    }
