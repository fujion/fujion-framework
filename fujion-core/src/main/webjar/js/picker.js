...
define('fujion-picker', ['fujion-core', 'fujion-widget', 'fujion-picker-css'], function(fujion) { 
	...
	fujion.widget.PickerWidget = fujion.widget.Popupbox.extend({
		...
		afterRender: function() {
			...
			if (!popup) {
				...
				popup.real$.addClass('fujion_picker-ddn');
			}
		},
	...
	/******************************************************************************************************************
	 * Base class for picker items.
	 ******************************************************************************************************************/
	
	fujion.widget.PickerItem = fujion.widget.UIWidget.extend({
		...
		afterRender: function() {
			this._super();
			this.widget$.on('mousedown', this.handleClick.bind(this));
		},
	...
	fujion.widget.Colorpicker = fujion.widget.PickerWidget.extend({
		
		/*------------------------------ Containment ------------------------------*/
		
		addChild: function() {
			if (this._usingDefaults) {
				this._usingDefaults = false;
		...
		updateSelection: function(color, showText) {
			...
			if (color) {
				if (showText) {
					this.input$().css('background', 'linear-gradient(90deg, ' + color + ' 28px, transparent 0')
				} else {
	...
	fujion.widget.Colorpickeritem = fujion.widget.PickerItem.extend({
	...
	/******************************************************************************************************************
	 * An image picker widget
	 ******************************************************************************************************************/ 
	
	fujion.widget.Imagepicker = fujion.widget.PickerWidget.extend({
	...
	/******************************************************************************************************************
	 * An image picker item
	 ******************************************************************************************************************/ 
	
	fujion.widget.Imagepickeritem = fujion.widget.PickerItem.extend({
